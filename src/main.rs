...
impl AudioOrbitApp {
    ...
    fn start_update_install(&mut self, check: updater::UpdateCheck) {
    ...
    fn open_releases_page(&mut self) {
...
impl AudioOrbitApp {
    ...
    fn render_updates_section_inner(&mut self, ui: &mut egui::Ui, show_title: bool) {
        if show_title {
            ui.heading("Updates");
        }
        ui.small(format!(
